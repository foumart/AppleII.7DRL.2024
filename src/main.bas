...
9140 V1 = 0 : V2 = 45 : V3 = 0 : V4 = 24 : GOSUB 300 : REM LIMIT SCROLL AREA
9150 UX = 0 : VX = 8 : UY = 112 : VY = 3 : GOSUB 400 : REM PRINT LEGEND ON SCREEN SO IT COULD THEN BE STORED
9180 GOSUB 350 : REM RESET SCROLL AREA
9190 REM VTAB(22) : HTAB(13)

9199 REM TODO: COMPLETE TEXT PAGE COPYING
9200 REM POKE 6,16 : POKE 7,0 : CALL 7936 : REM CALL 1F00 AND STORE TEXT SCREEN DATA AT 1000-13FF (MAIN MEMORY)
9210 REM POKE 6,20 : POKE 7,1 : CALL 7936 : REM CALL 1F00 AGAIN TO DO THE SAME WITH AUX TEXT PAGE
