...
400 POKE 240, 0 : REM LOW BYTE OF TEXT START ADDRESS
410 POKE 241, FILES(W,1) : REM HIGH BYTE OF TEXT START ADDRESS
420 POKE 242, FILES(W,2) AND 255 : REM LOW BYTE OF TEXT LENGTH
430 POKE 243, INT(FILES(W,2) / 256) : REM HIGH BYTE OF TEXT LENGTH
440 CALL 874
475 REM FOR I = UU TO VV
480 REM    PRINT LINES$(W, I);
485 REM NEXT I
490 RETURN
