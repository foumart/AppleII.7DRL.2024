...
7600 REM I = INT(RND(1) * 3 + 1)
7610 REM VISIBLES(1, I + 1) = 1
7620 GOTO 9000


7998 REM GENERATE MAP ROUTINE
7999 REM DEBUG 0: SILENT; 1: JUST DISPLAY LEVEL; 2: DISPLAY DEBUG INFO; 3: ALSO WAIT FOR USER INTERACTION
8000 IF DEBUG > 2 THEN VTAB(19) : HTAB(50) : PRINT "Hit Any Key..." : CALL 768 : RNG = RND(-1*(PEEK(78)+256*PEEK(79)))
