...
2170 FILES$(1) = "StartSeed" : FADDR$(1) = "0C00" : FILES(1,1) = 12 : FILES(1,2) = 997 : FILES(1,3) = 1  : FILES(1,4) = 14 : FILES(1,5) = 1
2185 FILES$(2) = "Encounter" : FADDR$(2) = "1000" : FILES(2,1) = 16 : FILES(2,2) = 952 : FILES(2,3) = 47 : FILES(2,4) = 13 : FILES(2,5) = 0
2210 FILES$(3) = "BeginGame" : FADDR$(3) = "1600" : FILES(3,1) = 22 : FILES(3,2) = 906 : FILES(3,3) = 48 : FILES(3,4) = 13 : FILES(3,5) = 4
...
2800 POKE 49237,0 : CALL 7760 : POKE 49236,0 : CALL 7760 : FF$ = "SCREEN" : FF = 1 : GOSUB 26000 : REM LOAD TITLE PICTURE
2850 FF = 2 : GOSUB 600
...
4000 REM IF FILES(J, 5) = 0 THEN GOTO 4060
4005 REM TA = FILES(J, 1) : TL = FILES(J, 2)
4010 REM FOR K = 0 TO INT(TL / 254) - 1
4015 REM   BUFFER$ = ""
4020 REM   FOR I = TA + K * 255 TO TA + K * 255 + 254
4025 REM     BUFFER$ = BUFFER$ + CHR$(PEEK(I))
4030 REM   NEXT I
4035 REM   LINES$(J, K + 1) = BUFFER$
4036 REM   POKE 49237,0 : POKE 1024 + 866 + J + K + FILES(J, 5), 86 : REM DISPLAY BUFFERING PROGRESS
4045 REM   POKE 49236,0 : POKE 1024 + 866 + J + K + FILES(J, 5), 87
4050 REM NEXT K
4060 REM BUFFER$ = "" 
4070 REM FOR I = TA + K * 255 TO TA + K * 255 + TL - INT(TL / 254) * 255
4080 REM   BUFFER$ = BUFFER$ + CHR$(PEEK(I))
4090 REM NEXT I
4100 REM LINES$(J, K + 1) = BUFFER$
...
6360 W = 3 : UU = 0 : VV = 0 : UZ = 0 : VZ = 0 : UX = 255 : VX = 23 : UY = 140 : VY = 1 : GOSUB 400
...
6405 W = 1 : UU = 0 : VV = 0 : UZ = 0 : VZ = 0 : UX = 0 : VX = 12 : UY = 0 : VY = 3 : GOSUB 400 : REM DRAW RANDOM SEED WINDOW AND SECOND SCREEN OF STORY ENDING (WITHOUT BOTTOM BUTTONS)
...
6795 W = 1 : UU = 0 : VV = 0 : UZ = 0 : VZ = 0 : UX = 231 : VX = 14 : UY = 252 : VY = 0 : GOSUB 400
...
9970 W = 3 : UU = 0 : VV = 0 : UZ = 0 : VZ = 0 : UX = 0 : VX = 0 : UY = 0 : VY = 0 : GOSUB 400 : REM RENDER GAME WELCOME SCREEN
...
12005 PRINT : PRINT D$;"RUN GAME" : END
