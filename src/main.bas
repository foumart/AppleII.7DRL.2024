...
20 FOR I = 7680 TO 7690 : REM WRITE THE MACHINE CODE IN THE BEGINNING OF THIS SAME BASIC FILE
30   READ K
40   POKE I,K
50 NEXT
...
2170 FILES$(1) = "StartSeed" : FADDR$(1) = "0C00" : FILES(1,1) = 12 : FILES(1,2) = 952 : FILES(1,3) = 1  : FILES(1,4) = 14 : FILES(1,5) = 1
2180 FILES$(2) = "BeginGame" : FADDR$(2) = "1000" : FILES(2,1) = 16 : FILES(2,2) = 1015 : FILES(2,3) = 48 : FILES(2,4) = 13 : FILES(2,5) = 4
2185 FILES$(3) = "Encounter" : FADDR$(3) = "1400" : FILES(3,1) = 20 : FILES(3,2) = 1002 : FILES(3,3) = 47 : FILES(3,4) = 13 : FILES(3,5) = 0
...
2800 POKE 49237,0 : CALL 7760 : POKE 49236,0 : CALL 7760 : FF$ = "SCREEN" : FF = 1
2820 VTAB(23) : HTAB(OFFSET + 29 + J * 2) : PRINT M$;L2$;N$;
2840 GOSUB 26000 : REM LOAD TITLE PICTURE
2850 FF = 2 : GOSUB 600
...
6405 UX = 0 : VX = 12 : UY = 200 : VY = 2 : GOSUB 400 : REM FILES(1) DRAW RANDOM SEED WINDOW AND SECOND SCREEN OF STORY ENDING (WITHOUT BOTTOM BUTTONS)
...
6795 UX = 181 : VX = 14 : UY = 254 : VY = 0 : GOSUB 400
...
8960 V1 = 47 : V2 = 33 : V3 = 14 : V4 = 24 : GOSUB 300 : REM LIMIT SCROLL AREA
8970 UX = 0 : VX = 16 : UY = 228 : VY = 1 : GOSUB 400 : REM FILES(3) RENDER GAME WELCOME SCREEN
8980 GOSUB 350 : REM RESET SCROLL AREA
8990 REM VTAB 21 : HTAB 1 : PRINT : VTAB 21 : HTAB 1
9030 REM UX = 136 : VX = 19 : UY = 108 : VY = 0 : GOSUB 400 : REM FILES(3) DRAW TEXT TODO
9100 VTAB 22 : HTAB 1 : PRINT : VTAB 22 : HTAB 1 : PRINT M$;"SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS";N$ :
9170 VTAB 23 : HTAB 1 : PRINT "Loading..."
...
11998 REM POKE 104,96 : POKE 24576,0 : REM LOAD THE GAME AT $6000 IF HGR2 IS NEEDED
11999 REM LOAD THE GAME AT $4000
12000 POKE 104,64 : POKE 16384,0 : REM WRITE TO {$67}{$68} THE BEGINNING OF THE BASIC FILE
...
21050 VTAB(12) : HTAB(50) : PRINT ITEMS$(1,1);M$;"_";N$; : VTAB(13) : HTAB(50) : PRINT ITEMS$(1,2);M$;"_";N$;
21060 VTAB(12) : HTAB(60) : PRINT ITEMS$(2,1);M$;"_";N$; : VTAB(13) : HTAB(60) : PRINT ITEMS$(2,2);M$;"_";N$;
21070 VTAB(12) : HTAB(70) : PRINT ITEMS$(3,1); : VTAB(13) : HTAB(70) : PRINT ITEMS$(3,2);
21190 RETURN
...
60000 ER = PEEK(222)
60005 IF ER = 0 OR ER > 15 THEN PRINT : PRINT : CALL 7680
