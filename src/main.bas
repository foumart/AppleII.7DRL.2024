...
940 I = 1
945 VTAB(24) : HTAB(1)
950 RU = RND(1)*2 : RR = RND(1)*4 : RD = RND(1)*5 : RL = RND(1)*4 : REM DEFINE PROBABILITIES
...
17400 XX = MX+1 : GOSUB 200 : VTAB(MY+1) : ? "         "
17410 HTAB(MX+1) : VTAB(MY+2) : ? "         "
17430 HTAB(MX+1) : VTAB(MY+3) : ? "         "
17450 HTAB(MX+1) : VTAB(MY+4) : ? "         "
17460 HTAB(MX+1) : VTAB(MY+5) : ? "         "
