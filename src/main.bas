...
2170 FILES$(1) = "StartSeed" : FADDR$(1) = "0C00" : FILES(1,1) = 12 : FILES(1,2) = 999 : FILES(1,3) = 1  : FILES(1,4) = 14 : FILES(1,5) = 1
...
5550 UX = 197 : VX = 19 : UY =  50 : VY =  0 : GOSUB 400 : REM THIS WAS HIDDEN DURING HGR DISPLAY
...
6405 UX = 0 : VX = 12 : UY = 0 : VY = 3 : GOSUB 400 : REM FILES(1) DRAW RANDOM SEED WINDOW AND SECOND SCREEN OF STORY ENDING (WITHOUT BOTTOM BUTTONS)
...
6795 UX = 231 : VX = 14 : UY = 254 : VY = 0 : GOSUB 400
...
9100 VTAB 22 : HTAB 1 : PRINT : VTAB 22 : HTAB 1 : PRINT M$;"[SSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS[";N$ :
9170 VTAB 23 : HTAB 1 : PRINT "Room is empty."
9240 VTAB 24 : HTAB 1 : PRINT "There are exits leading to N/E.";
