...
770 INSIDES(X, Y) = 1 : VISIBLES(X,Y) = 1 : MAP(X,Y) = 1 : POKE 1022,5 + 9*(X-1) : REM WRITE INITIAL PLAYER POSITION
...
16900 IF V > 0 THEN WW = MX+1 : GOSUB 200 : VTAB(MY+2) : ? M$;"Z_";N$;"     ";M$;"Z_";N$
...
17300 IF V = 0 THEN WW = MX+1 : GOSUB 200 : VTAB(MY+2) : ? M$;"ZVWVWVWV_";N$
...
21210 HP = 20 - INT(RND(1) * 5) - INT(RND(1) * 3 + 1) * CLASS: IF HP < 10 THEN HP = 10
...
21300 AM = 1 : IF CLASS = 2 THEN AM = AM + INT(RND(1) * 3 + DX)
