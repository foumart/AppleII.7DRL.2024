...
2185 FILES$(3) = "Encounter" : FADDR$(3) = "0800" : FILES(3,1) = 8 : FILES(3,2) = 874 : FILES(3,3) = 47 : FILES(3,4) = 13 : FILES(3,5) = 0
...
2800 POKE 49237,0 : CALL 872 : POKE 49236,0 : CALL 872 : FF$ = "SCREEN" : FF = 1 : REM CALL $0368 CLEAR DHGR SCREENS
...
8965 HOME
8970 UX = 0 : VX = 8 : UY = 44 : VY = 1 : VTAB(9) : GOSUB 400 : REM RENDER EQUIPMENT UI
...
11997 REM POKE 104,32 : POKE 16384,0
11998 REM POKE 103,0 : POKE 104,8 : POKE 2048,0 : REM LOAD FROM DEFAULT $800 (WRITE TO {$67}{$68} THE BEGINNING OF THE BASIC FILE)
12000 POKE 104,16 : POKE 4096,0 : REM LOAD THE GAME AT $1000 ONWARDS THROUGH THE GRAPHIC PAGES UP TO DOS AREA 95FF
