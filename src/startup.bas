...
420 REM 1000-13F7 (4096-5111)  BEGINGAME (LENGTH: 1015 - BYTES; 13F8-13FF 5112-5119 IS FREE)
430 REM 0C00-0FC5 (3072-4037)  LEGEND (LENGTH: 967; OVERWRITING STARTSEED; 0FC6-0FFF 4038-4095 IS FREE)
440 REM 1000-13FF (4096-5111)  FREE SPACE
450 REM 1400-???? (5120-????)  ENCOUNTER (CURRENT LENGTH: 1206 - BYTES)
