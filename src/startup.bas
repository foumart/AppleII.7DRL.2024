...
124 REM 00CE (206)             LOW BYTE OF TEXT PRINT POINTER
126 REM 00CF (207)             HIGH BYTE OF TEXT PRINT POINTER
...
461 REM 1D00-1D2E (825-914)  PRINT MOUSE TEXT ROUTINE
...
1300 PRINT D$"BLOAD CLEARDHR" : REM LOADS A ROUTINE TO CLEAR DHR AT $1E50 (7760)
...
1500 TL = 1497 : REM THE LENGTH OF THE TEXT DATA TO LOAD
1505 UU = 0 : REM SET HOW MUCH TEXT TO SKIP AT BEGINNING
1510 VV = 0 : REM SET HOW MUCH TEXT TO SKIP FROM END
1515 PRINT D$"BLOAD UI, TTXT, A$1000"
1530 VTAB(23) : HTAB(43) : ? M$;"VWV";N$; : REM END
...
1570 POKE 237, 250        : REM SET $ED - LOW BYTE OF TEXT LENGTH
1580 POKE 238, 5     : REM SET $EE - HIGH BYTE OF TEXT LENGTH
1582 POKE 254, 0        : REM SET $FF - LOW BYTE OF TEXT TO SKIP AT BEGINNING
1584 POKE 251, 0     : REM SET $FB - HIGH BYTE OF TEXT TO SKIP AT BEGINNING
1586 POKE 252, VV AND 255        : REM SET $FC - LOW BYTE OF TEXT TO SKIP BEFORE END
1588 POKE 253, INT(VV / 256)     : REM SET $FD - HIGH BYTE OF TEXT TO SKIP BEFORE END
1590 VTAB(23) : HTAB(46) : ? M$;"V";N$; : VTAB(1) : ? : VTAB(1) : HTAB(1)
1600 CALL 7424 : PRINT
1610 PRINT D$"BLOAD UI2, TTXT, A$1000"
1740 TL = 372 : REM VTAB(23) : HTAB(47) : ? M$;"V";N$;
1750 POKE 235, 0                 : REM SET $EB - LOW BYTE OF TEXT START/POINTER (0 DECIMAL = $00)
1760 POKE 236, 16                : REM SET $EC - HIGH BYTE TEXT START/POINTER (16 DECIMAL = $10)
1770 POKE 237, 118        : REM SET $ED - LOW BYTE OF TEXT LENGTH
1780 POKE 238, 1     : REM SET $EE - HIGH BYTE OF TEXT LENGTH
1782 POKE 254, 0        : REM SET $FF - LOW BYTE OF TEXT TO SKIP AT BEGINNING
1784 POKE 251, 0     : REM SET $FB - HIGH BYTE OF TEXT TO SKIP AT BEGINNING
1786 POKE 252, VV AND 255        : REM SET $FC - LOW BYTE OF TEXT TO SKIP BEFORE END
1788 POKE 253, INT(VV / 256)     : REM SET $FD - HIGH BYTE OF TEXT TO SKIP BEFORE END
1790 VTAB(23) : HTAB(48) : ? M$;"V";N$; : VTAB(18) : ? : VTAB(16) : HTAB(1)
1800 CALL 7424
