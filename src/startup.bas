...
1515 VTAB(23) : HTAB(35) : ? M$;"VW";N$; : VTAB(1) : ? : VTAB(1) : HTAB(1)

1520 PRINT D$;"BLOAD PRINTMT"
1530 PRINT D$;"BLOAD UI,TTXT,A$1000"
1550 POKE 240, 0      : REM low byte of $1000 is 0
1580 POKE 241, 16     : REM high byte of $1000 (16 decimal = $10)
1600 POKE 242, 1869 AND 255      : REM low byte of TL
1620 POKE 243, INT(1869 / 256)     : REM high byte of TL
1640 CALL 16384
