...
9999 REM TEXT
10000 TEXT : VTAB(1)
10200 POKE 49237,0: PRINT D$;"BLOAD SCREEN, A$2000, L$2000"
10500 POKE 49236,0: PRINT D$;"BLOAD SCREEN, A$2000, L$2000, B$2000"
10800 POKE 49232,0: REM TURN ON GRAPHICS
10810 POKE 49235,0: REM TURN ON MIXED MODE
10820 POKE 49246,0: REM TURN ON DHR
