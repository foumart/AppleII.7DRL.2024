...
470 REM 2000-3FFF (8192-16383)  GRAPHIC PAGE 1 IS KEPT FREE DURING LOAD TO DISPLAY IMAGES (FOR MAIN.BAS ONLY)
...
1530 PRINT D$"BLOAD STORETXT" : REM STORE TEXT SCREEN ROUTINE $1F00
1545 VTAB(23) : HTAB(47) : ? M$;"V";N$;
1550 PRINT D$"BLOAD RESTORE" : REM RESTORE STORED TEXT ROUTINE AT $1F68
1555 VTAB(23) : HTAB(48) : ? M$;"W";N$;
...
1600 CALL 825 : REM CALL PRINT MOUSE TEXT ROUTINE
