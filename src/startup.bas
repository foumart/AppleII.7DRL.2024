...
72 REM 0078,79 (120,121) RANDOM SEED NUMBER 1 AND 2
73 REM 0068 (104)        THE HIGH BYTE OF THE BASIC PROGRAM CUSTOM LOADING ADDRESS

75 REM 0300 - 030F (768) RANDOMIZE SEED ROUTINE WITH RND(NEGATIVE)
76 REM 0310 - 0338 (784) READCHAR ROUTINE
77 REM 033A - 0344 (826) ERROR HANDLING ROUTINE
80 REM 03FF (1023)       DEBUG (1-3:ON, 0:OFF)
86 REM 03FE (1022)       PLAYER X POSITION
87 REM 03FE (1021)       PLAYER Y POSITION
...
991 REM DEBUG 2: SKIPS LOADING TEXT DATA FOR FASTER DEBUGGING, ALSO USING RANDOMIZED SEED TO PRODUCE DIFFERENT LEVELS
992 REM DEBUG 3: STARTS WITH VISIBLE SILENT MAP GENERATION, USING DEFAULT SEED - WILL PRODUCE THE SAME LEVEL EACH TIME
993 REM DEBUG 4: WAIT FOR USER INTERACTION ON EACH STEP DURING MAP GENERATION USING DEFAULT SEED
