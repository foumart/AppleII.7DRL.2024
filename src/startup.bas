...
1260 PRINT
1270 NEXT O
1280 HTAB(OFFSET) : PRINT N$;"_            ___________________"
1350 HTAB(OFFSET) : PRINT M$;"C";N$;" Preparing ";M$;"Z";
1400 FOR P = 1 TO Z + 4
1410 PRINT "\\";
1420 NEXT P
1430 PRINT "_";N$;
1435 VTAB(24) : HTAB(OFFSET + 13) : FOR P = 1 TO Z + 4 : PRINT M$;"L";N$; : NEXT P
...
1600 VTAB(23) : HTAB(OFFSET + 13) : PRINT M$;" ";N$; : PRINT D$;"OPEN UI"
1800 PRINT N$;M$;LO$;N$; : PRINT D$;"READ UI" : HTAB(OFFSET + 31) : PRINT M$;"^_";N$;
1900 INPUT L : REM GET THE TOTAL LINES OF THE TEXT FILE (FIRST PARAMETER FROM TEXT FILE)
2000 HTAB(OFFSET + 15) : PRINT N$;M$;LO$;N$;
2050 INPUT H : REM REM GET LEFT OFFSET WHEN INSERTING THE TEXT (SECOND PARAMETER FROM TEXT FILE)
2080 HTAB(OFFSET + 32) : PRINT N$;M$;"_";N$;
2100 INPUT V : REM VTAB(V) : REM GET TOP OFFSET WHEN INSERTING THE TEXT (THIRD PARAMETER FROM TEXT FILE)
2300 HTAB(OFFSET + 15 + I) : PRINT N$;M$;LO$;N$;
2350 INPUT A$ : REM GET THE NEXT DATA ROW
2380 HTAB(OFFSET + 32) : PRINT N$;M$;"_";N$;
2400 LINES$(I) = A$ : I = I + 1
2450 IF I > L THEN GOTO 2600
2500 GOTO 2300 : REM ITERATE LINES
2600 HTAB(OFFSET + 31) : PRINT N$;M$;" ";N$;M$;"_";N$ : PRINT D$;"CLOSE"
...
7210 VTAB(22) : HTAB(OFFSET) : PRINT M$;"I";N$ : HTAB(OFFSET) : PRINT M$;"C";N$;" Buffering ";M$;"Z ";
