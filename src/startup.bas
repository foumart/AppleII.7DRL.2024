...
1515 REM VTAB(23) : HTAB(35) : ? M$;"VW";N$; : VTAB(1) : ? : VTAB(1) : HTAB(1)
1516  VTAB(1) : ? : VTAB(1) : HTAB(1)

1520 REM PRINT D$;"BLOAD SCRN1, A$8000, L$400" : REM Load saved text screen
1530 PRINT D$"BLOAD UI,TTXT,A$1000"
1540 PRINT D$"BLOAD PRINTMT" : REM Print Mouse Text routine
1550 POKE 240, 0      : REM low byte of $1000 is 0
1560 POKE 241, 16     : REM high byte of $1000 (16 decimal = $10)
1570 POKE 242, 1869 AND 255      : REM low byte of TL
1580 POKE 243, INT(1869 / 256)     : REM high byte of TL
1581 POKE 225,0              : REM Initialize BLK (at $E1) to 0
1600 CALL 16384 : ?

1605 REM FOR I = 0 TO 1024
1610 REM   POKE 1024 + I, PEEK(32768 + I)
1620 REM NEXT I

1630 REM PRINT D$;"BLOAD UI,TTXT,A$1000"
1650 REM POKE 240, 0      : REM low byte of $1000 is 0
1680 REM POKE 241, 16     : REM high byte of $1000 (16 decimal = $10)
1700 REM POKE 242, 1869 AND 255      : REM low byte of TL
1720 REM POKE 243, INT(1869 / 256)     : REM high byte of TL
1740 REM CALL 16384

2530 REM VTAB(23) : HTAB(35) : ? M$;"VW";N$; : VTAB(1) : ? : VTAB(1) : HTAB(1)

2540 REM FOR I = 0 TO INT(TL / 170)
2550 REM   FOR J = TADDR + I * 171 TO TADDR + I * 171 + 170
2560 REM     PRINT CHR$(PEEK(J));
2570 REM   NEXT J
2580 REM   POKE 49237,0 : POKE 1890 + I, 86 : REM DISPLAY BUFFERING PROGRESS
2590 REM   POKE 49236,0 : POKE 1890 + I, 87
2610 REM NEXT I
