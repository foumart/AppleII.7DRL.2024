...
100 REM ZERO-PAGE MEMORY LOCATIONS THAT ARE BEEN ACCESSED:
105 REM 0006 (6)               READCHAR CODE PLACEHOLDER
110 REM 0078,79 (120,121)      RANDOM SEED NUMBER 1 AND 2 (LINE EXECUTED/STOPPED, ETC.)
112 REM 0068 (104)             THE HIGH BYTE OF THE BASIC PROGRAM CUSTOM LOADING ADDRESS
115 REM 0067 (103)             LOW BYTE OF THE BASIC PROGRAM ($0801 IS THE DEFAULT)

120 REM PRINTMT ROUTINE
122 REM 00EB (235)             LOW BYTE OF TEXT START POINTER (0 DECIMAL = $00)
124 REM 00EC (236)             HIGH BYTE TEXT START POINTER (16 DECIMAL = $10)
126 REM 00ED (237)             LOW BYTE OF TEXT LENGTH
128 REM 00EE (238)             HIGH BYTE OF TEXT LENGTH

139 REM ASSEMBLY ROUTINES:
...
395 REM MAIN & GAME
400 REM 0800-0BFF (2048-3071)  THIS IS THE DEFAULT BASIC LOADING ADDRESS, ALSO TEXT PAGE 2 on 80COL
410 REM 0800-0BF3 (2048-3059)  LOAD / MAIN - STARTSEED (LENGTH: 1011 BYTES)
420 REM 1000-13F7 (4096-5111)  LOAD / MAIN - BEGINGAME (LENGTH: 1015 BYTES)

425 REM 0800-0B6C (2048-2924)  MAIN / GAME - LEGEND (LENGTH: 876 BYTES)
440 REM 0C00-0F6A (3072-3946)  MAIN / GAME - ENCOUNTER (LENGTH: 874 - BYTES)
445 REM 1000-17FF (4096-8191)  SCRATCH FOR TEXT PRINT (2 SEPARATE 80COL PAGES)
450 REM 1F00-1F7F (7936-????)  STORETXT ROUTINE (LENGTH: 103 BYTES)
455 REM 1F80-1FFF (8064-????)  RESTORETXT ROUTINE (LENGTH: 103 BYTES)
460 REM 2000-95FF (8192-38399)  GAME BASIC AND VARIABLES

470 REM 2000-3FFF (8192-16383)  GRAPHIC PAGE 1 IS KEPT FREE DURING LOAD AND GENERATION TO DISPLAY IMAGES (FOR MAIN.BAS ONLY)
480 REM 4000-95FF (16384-38399) SPACE FOR BASIC FILES AND VARIABLES (WON'T BE USING GRAPHIC PAGE 2)
...
1342 VTAB(23) : HTAB(35) : ? M$;CHR$(255);N$; : VTAB(23) : HTAB(35) : ? M$;"V";N$;M$;"W";N$;
...
1500 PRINT D$"BLOAD UI, TTXT, A$1000" : REM LENGTH 1981 BYTES $1000 - $17BD (TEMPORARY)
1510 VTAB(23) : HTAB(43) : ? M$;"V";N$;M$;"W";N$;
1520 PRINT D$"BLOAD PRINTMT" : REM FAST PRINT TEXT ROUTINE AT $0339
1525 VTAB(23) : HTAB(45) : ? M$;"V";N$;M$;"W";N$;
1530 REM PRINT D$"BLOAD STORETXT" : REM STORE TEXT SCREEN ROUTINE $1F00
1545 REM VTAB(23) : HTAB(47) : ? M$;"VW";N$;
1550 REM PRINT D$"BLOAD RESTORE" : REM RESTORE STORED TEXT ROUTINE AT $1F68
1555 REM VTAB(23) : HTAB(48) : ? M$;"W";N$;
1560 VTAB(1) : ? : VTAB(1) : HTAB(1)
1570 POKE 235, 0             : REM SET $EB - LOW BYTE OF TEXT START/POINTER (0 DECIMAL = $00)
1575 POKE 236, 16            : REM SET $EC - HIGH BYTE TEXT START/POINTER (16 DECIMAL = $10)
1580 POKE 237, 188           : REM SET $ED - LOW BYTE OF TEXT LENGTH
1590 POKE 238, 7             : REM SET $EE - HIGH BYTE OF TEXT LENGTH
1600 CALL 825 : REM CALL PRINT UI AND STORY MOUSE TEXT ROUTINE
1610 VTAB(23) : HTAB(47) : ? M$;"VW";N$; : REM VTAB(18) : ? : VTAB(16) : HTAB(1)
