...
8 REM ALL REMS WILL BE REMOVED DURING COMPILE, THEN A SINGLE REM WILL BE ADDED JUST ENOUGH
9 REM TO CONTAIN THE SPECIAL ERROR HANDLING ROUTINE BELOW:
10 ONERR GOTO 60000 : REM BETTER ERROR HANDLING (NEEDS 14 BYTES AT THE BEGINNING IN A REM)
25 FOR I = 8198 TO 8211 : REM WRITE THE MACHINE CODE IN THE BEGINNING OF THIS SAME BASIC FILE
30   READ K
40   POKE I,K
50 NEXT
...
499 REM PRINT LINE AT THE BOTTOM, CLEARING 45 CHARACTERS TOTAL

500 WW = 1 : GOSUB 200 : VTAB(24) : PRINT SPC(45); : REM SPC(45);
510 WW = 1 : GOSUB 200 : VTAB(23) : PRINT LI$;SPC(45 - LEN(LI$))
530 RETURN
...
2000 D$ = CHR$(4) : REM : PRINT D$"BLOAD RESTORE" : REM LOAD AT $1F70 (8048)
2002 AVAIL = FRE(0)
2005 DEBUG = PEEK(1023) : REM GET DEBUG SETTING SAVED BY STARTUP
...
9210 REM PRINT MI$;" ? ";NI$;M$;"_";N$ : PRINT M$;"LLL";N$
...
9800 HOME : PRINT "Ready. Press (";MI$;"?";NI$;") for help." : REM VTAB(24) : DEBUG = 1 : GOSUB 800
...
10070 KY = PEEK(49152) : REM GOSUB 24000 : REM GET LAST PRESSED KEY AND DISPLAY DEBUG CURSOR INFO
10100 IF KY = 0 THEN GOTO 10000
10110 IF KY = K THEN GOTO 10000
10120 K = KY : POKE 49168,0 : REM CLEAR THE KEYBOARD STROBE - ALWAYS AFTER READING KEYBOARD

10130 REM VTAB(24) : PRINT X;" ";Y;" ";RX;" ";RY;
10140 REM DISPLAY THE MAP CHAR AT THE PLAYER'S PREVIOUS POSITION AND PERFORM MOVE
10150 HTAB(X) : VTAB(Y)
10160 PRINT A$
10170 REM AA$ = A$ : REM TODO : FIX BLINKING
10180 rem IF K = 197 OR K = 229 THEN GOTO 12300 : REM TOGGLE DEBUG WITH "E"

10190 REM -> (21)    D (68)     d (100)    L (76)     l (108)
10200 IF K = 149 OR K = 196 OR K = 228 OR K = 204 OR K = 236 THEN TURN = TURN + 1 : ZX = 1 : ZY = 0 : GOTO 12500 : REM RIGHT
10210 REM K = 21 OR K = 149 OR K = 68 OR K = 196 OR K = 100 OR K = 228 OR K = 76 OR K = 204 OR K = 108 OR K = 236 THEN GOTO 12500 : REM MOVING = 1 : MDIR = 1 : GOTO 12500 : REM RIGHT

10220 REM <- (8)     A (65)     a (87)     J (74)     j (106)
10230 IF K = 136 OR K = 193 OR K = 225 OR K = 202 OR K = 234 THEN TURN = TURN + 1 : ZX = -1 : ZY = 0 : GOTO 13000 : REM LEFT
10240 REM IF K = 8 OR K = 136 OR K = 65 OR K = 193 OR K = 97 OR K = 225 OR K = 74 OR K = 202 OR K = 106 OR K = 234 THEN GOTO 13000 : REM MOVING = 1 : MDIR = -1 : GOTO 13000 : REM LEFT

10250 REM ^ (11)     W (87)     w (119)    I (73)     i (105)
10260 IF K = 139 OR K = 215 OR K = 247 OR K = 201 OR K = 233 THEN TURN = TURN + 1 : ZX = 0 : ZY = -1 : GOTO 13500 : REM UP
10270 REM IF K = 8 OR K = 136 OR K = 65 OR K = 193 OR K = 97 OR K = 225 OR K = 74 OR K = 202 OR K = 106 OR K = 234 THEN GOTO 13500 : REM UP

10280 REM v (10)     S (83)     s (115)    K (75)     k (107)
10290 IF K = 138 OR K = 211 OR K = 243 OR K = 203 OR K = 235 THEN TURN = TURN + 1 : ZX = 0 : ZY = 1 : GOTO 14000 : REM DOWN
10300 REM IF K = 10 OR K = 138 OR K = 83 OR K = 211 OR K = 115 OR K = 243 OR K = 75 OR K = 203 OR K = 107 OR K = 235 THEN GOTO 14000 : REM DOWN

10310 IF K = 32 OR K = 160 THEN GOTO 14500 : REM SPACE, PASS
10315 IF TURN > 0 THEN GOTO 10000

10320 IF TURN = 0 AND K = 191 THEN GOSUB 10600

10450 GOTO 10000

10499 REM 
10500 REM VTAB(1) : HTAB(1) : V1 = 0 : V2 = 45 : V3 = 0 : V4 = 24 : GOSUB 300 : UX = 0 : VX = 8 : UY = 111 : VY = 3 : GOSUB 400 : GOSUB 350
10505 REM DIM SL(1023)
10510 REM FOR I = 0 TO 1023 : SL(I) = PEEK(1024 + I) : NEXT I
10515 REM POKE 49152,0
10520 REM DIM SR(1023)
10525 REM FOR I = 0 TO 1023: SR(I) = PEEK(1024 + I): NEXT I
10530 REM POKE 49152,1
10540 REM HOME
10545 REM --- RESTORE TEXT SCREEN ---
10550 REM FOR I = 0 TO 1023 : POKE (1024 + I), SL(I) : NEXT I
10555 REM POKE 49152,0
10560 REM FOR I = 0 TO 1023: POKE (1024 + I), SR(I): NEXT I
10565 REM POKE 49152,1
10585 REM END

10599 REM TODO: COMPLETE TEXT COPY WITH STORETXT
10600 V1 = 0 : V2 = 45 : V3 = 0 : V4 = 24 : GOSUB 300 : VTAB(1)
10610 UX = 0 : VX = 8 : UY = 112 : VY = 3 : GOSUB 400 : REM PRINT LEGEND
10615 REM POKE 239, 16 : CALL 8048 : REM 8040 : REM LOAD TEXT TEMP
10620 GOSUB 350
10630 V1 = 47 : V2 = 33 : V3 = 9 : V4 = 24 : GOSUB 300
10635 UX = 0 : VX = 16 : UY = 228 : VY = 1 : VTAB(14) : GOSUB 400 : REM PRINT WELCOME TEXT
10640 GOSUB 350
10645 POKE 2039, 76 : REM PRINT LAST BORDER
10650 VTAB(22) : HTAB(1) : PRINT : VTAB(23) : HTAB(1) : PRINT "  _               _            _"
10655 REM VTAB(22) : HTAB(19) : PRINT M$;"H";N$;"< help >";M$;"U";N$
10665 VTAB(24) : PRINT " ";M$;"Z";N$;MI$;"I";NI$;M$;"_";N$;" Inventory   ";M$;"Z";N$;MI$;"S";NI$;M$;"_";N$;" Spells   ";M$;"Z";N$;MI$;"E";NI$;M$;"_";N$;" Equipment";
10670 CALL 768
10675 V1 = 0 : V2 = 45 : V3 = 0 : V4 = 16 : GOSUB 300 : HOME : GOSUB 350 : REM CLEAR LEGEND
10680 GOSUB 10700 : REM PRINT EMPTY FRAME
10685 VTAB(Y) : HTAB(X) : GOSUB 800 : REM FRE
10690 RETURN

10700 V1 = 47 : V2 = 33 : V3 = 15 : V4 = 24 : GOSUB 300 : REM LIMIT SCROLL AREA TO BOTTOM RIGHT
10710 UX = 77 : VX = 13 : UY = 236 : VY = 0 : HOME : VTAB(15) : GOSUB 400 : REM PRINT ENCOUNTER
10720 UX = 235 : VX = 13 : UY = 120 : VY = 0 : VTAB(20) : GOSUB 400 : REM PRINT CHOISES : TODO
10730 VTAB(15) : HTAB(53) : PRINT MI$;"Room View";NI$
10740 GOSUB 350
10750 LI$ = "Ready." : GOSUB 500
10760 RETURN
...
12499 REM 160:SPACE; 90:RIGHT WALL; 92:CORRIDOR; 93:ENTRANCE; 95:LEFT WALL;
...
12510 IF A = 255 THEN LI$ = "Entering Room..." : GOSUB 500 : GOTO 12850
12515 LI$ = "Blocked."
12599 REM OPEN DOOR RIGHT 94:DOOR
12600 IF A = 94 THEN LI$ = "Opened Door." : GOSUB 12960
12649 REM ENEMIES 
12650 IF (A > 192 AND A < 219) OR (A > 224 AND A < 251) THEN 12800
12699 REM BLOCKED RIGHT
12700 IF A <> 160 AND A <> 93 AND A <> 90 AND (A <> 92 OR A = 92 AND Y<>19 AND Y<>15 AND Y<>11 AND Y<>7 AND Y<>3) THEN X = X - 1 : GOSUB 100 : GOSUB 500 : GOTO 12800
12710 LI$ = "Moved East." : GOSUB 500
...
13010 IF A = 255 THEN LI$ = "Entering Room..." : GOSUB 500 : GOTO 13350
13020 LI$ = "Blocked." 
13099 REM OPEN DOOR LEFT
13100 IF A = 94 THEN LI$ = "Opened Door." : GOSUB 13460
12149 REM ENEMIES 
12150 IF (A > 192 AND A < 219) OR (A > 224 AND A < 251) THEN 13300
13199 REM BLOCKED LEFT
13200 IF A <> 160 AND A <> 93 AND A <> 95 AND (A <> 92 OR A = 92 AND Y<>19 AND Y<>15 AND Y<>11 AND Y<>7 AND Y<>3) THEN X = X + 1 : GOSUB 100 : GOSUB 500 : GOTO 13300
13210 LI$ = "Moved West." : GOSUB 500
...
13560 IF A = 255 THEN LI$ = "Entering Room..." : GOSUB 500 : GOTO 13850
13570 LI$ = "Blocked."
13599 REM OPEN DOOR UP
13600 IF A = 94 THEN LI$ = "Opened Door." : GOSUB 13960
13649 REM ENEMIES 
13650 IF (A > 192 AND A < 219) OR (A > 224 AND A < 251) THEN 13800
13698 REM BLOCKED UP
13700 IF A <> 160 AND A <> 93 AND A <> 95 AND A <> 90 THEN Y = Y + 1 : GOSUB 100 : GOSUB 500 : GOTO 13800
13710 LI$ = "Moved North." : GOSUB 500
...
14100 IF A = 255 THEN LI$ = "Entering Room..." : GOSUB 500 : GOTO 14350
14110 LI$ = "Blocked."
14149 REM OPEN DOOR DOWN
14150 IF A = 94 THEN LI$ = "Opened Door." : GOSUB 14460
14160 REM ENEMIES 
12180 IF (A > 192 AND A < 219) OR (A > 224 AND A < 251) THEN 14300
14199 REM BLOCKED DOWN
14200 IF A <> 160 AND A <> 93 AND A <> 95 AND A <> 90 THEN Y = Y - 1 : GOSUB 100 : GOSUB 500 : GOTO 14300
14210 LI$ = "Moved South." : GOSUB 500
...
15102 UX = 77 : VX = 13 : UY = 60 : VY = 1 : HOME : VTAB(15) : GOSUB 400 : REM PRINT ENCOUNTER
15104 UX = 136 : VX = 14 : UY = 129 : VY = 0 : VTAB(22) : GOSUB 400 : REM PRINT CHOISES : TODO
15106 GOSUB 350
...
60000 ER = PEEK(222)
60005 IF ER = 0 OR ER > 15 THEN PRINT : PRINT : CALL 8198
