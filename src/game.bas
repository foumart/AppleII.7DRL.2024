...
9700 REM IF RX < SIZE-1 THEN GOSUB 14700 : REM PLACE DOOR LEADING TO A ROOM ON THE RIGHT
...
16350 IF V > 1 OR (V = 1 AND VISIBLES(X1, Y1-1) > 0) THEN ? " ";M$;"\\\\7\\\\\\\\\";N$;" "; : GOTO 17000 : REM DRAW IN BETWEEN ROOM VERTICAL SPACE
