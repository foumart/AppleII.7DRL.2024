...
15099 REM TODO: FIX
15100 REM V1 = 47 : V2 = 33 : V3 = 15 : V4 = 24 : GOSUB 300 : REM LIMIT SCROLL AREA TO BOTTOM RIGHT
15102 REM UX = 77 : VX = 21 : UY = 60 : VY = 1 : HOME : VTAB(15) : GOSUB 400 : REM PRINT ENCOUNTER
15104 REM UX = 136 : VX = 22 : UY = 130 : VY = 0 : VTAB(22) : GOSUB 400 : REM PRINT CHOISES
15106 REM GOSUB 350
15110 REM UX = 197 : VX = 20 : UY =  50 : VY =  0 : GOSUB 400
15120 GOSUB 15550 : REM GENERATE ENEMIES FOR THIS ROOM
15150 GOSUB 15700 : REM LIST ENEMIES
...
15700 LB = 0
15702 IF C1(1) > 0 AND LP < 2 THEN LB = LB + 1 : VTAB(17 + LB) : GOSUB 15800
15705 IF C4(1) > 0 AND LP < 3 THEN LB = LB + 1 : VTAB(17 + LB) : GOSUB 15830
15710 IF C7(1) > 0 AND LP < 4 THEN LB = LB + 1 : VTAB(17 + LB) : GOSUB 15860
15715 IF C2(1) > 0 AND LP < 5 THEN LB = LB + 1 : VTAB(17 + LB) : GOSUB 15810
15720 IF C5(1) > 0 AND LP < 6 THEN LB = LB + 1 : VTAB(17 + LB) : GOSUB 15840
15725 IF C8(1) > 0 AND LP < 7 THEN LB = LB + 1 : VTAB(17 + LB) : GOSUB 15870
15730 IF C3(1) > 0 AND LP < 8 THEN LB = LB + 1 : VTAB(17 + LB) : GOSUB 15820
15735 IF C6(1) > 0 AND LP < 9 THEN LB = LB + 1 : VTAB(17 + LB) : GOSUB 15850
15740 IF C9(1) > 0 AND LP < 10 THEN LB = LB + 1 : VTAB(17 + LB) : GOSUB 15880
15790 RETURN
15800 HTAB(50) : PRINT LB;". ";"Knight";" HP:";C1(4);" AT:";C1(3);" DF:";C1(5);" '";(C1(7)-C1(8));"0"; : RETURN
15810 HTAB(50) : PRINT LB;". ";"Archer";" HP:";C2(4);" AT:";C2(3);" DF:";C2(5);" '";(C2(7)-C2(8));"0"; : RETURN
15820 HTAB(50) : PRINT LB;". ";"Wizard";" HP:";C3(4);" AT:";C3(3);" DF:";C3(5);" '";(C3(7)-C3(8));"0"; : RETURN
15830 HTAB(50) : PRINT LB;". ";"Knight";" HP:";C4(4);" AT:";C4(3);" DF:";C4(5);" '";(C4(7)-C4(8));"0"; : RETURN
15840 HTAB(50) : PRINT LB;". ";"Archer";" HP:";C5(4);" AT:";C5(3);" DF:";C5(5);" '";(C5(7)-C5(8));"0"; : RETURN
15850 HTAB(50) : PRINT LB;". ";"Wizard";" HP:";C6(4);" AT:";C6(3);" DF:";C6(5);" '";(C6(7)-C6(8));"0"; : RETURN
15860 HTAB(50) : PRINT LB;". ";"Knight";" HP:";C7(4);" AT:";C7(3);" DF:";C7(5);" '";(C7(7)-C7(8));"0"; : RETURN
15870 HTAB(50) : PRINT LB;". ";"Archer";" HP:";C8(4);" AT:";C8(3);" DF:";C8(5);" '";(C8(7)-C8(8));"0"; : RETURN
15880 HTAB(50) : PRINT LB;". ";"Wizard";" HP:";C9(4);" AT:";C9(3);" DF:";C9(5);" '";(C9(7)-C9(8));"0"; : RETURN
