...
3499 REM CURRENT ENEMIES; 1:TYPE; 2:LEVEL; 3:ATTACK; 4:HEALTH; 5:DEFENSE; 6:AMMO; 7:DISTANCE; 8:ADVANCED; 9:SLOT
3500 DIM C1(9)
3505 C1(1) = 0 : C1(2) = 0 : C1(3) = 0 : C1(4) = 0 : C1(5) = 0 : C1(6) = 0 : C1(7) = 0 : C1(8) = 0 : C1(9) = 0
3510 DIM C2(9)
3515 C2(1) = 0 : C2(2) = 0 : C2(3) = 0 : C2(4) = 0 : C2(5) = 0 : C2(6) = 0 : C2(7) = 0 : C2(8) = 0 : C2(9) = 0
3520 DIM C3(9)
3525 C3(1) = 0 : C3(2) = 0 : C3(3) = 0 : C3(4) = 0 : C3(5) = 0 : C3(6) = 0 : C3(7) = 0 : C3(8) = 0 : C3(9) = 0
3530 DIM C4(9)
3535 C4(1) = 0 : C4(2) = 0 : C4(3) = 0 : C4(4) = 0 : C4(5) = 0 : C4(6) = 0 : C4(7) = 0 : C4(8) = 0 : C4(9) = 0
3540 DIM C5(9)
3545 C5(1) = 0 : C5(2) = 0 : C5(3) = 0 : C5(4) = 0 : C5(5) = 0 : C5(6) = 0 : C5(7) = 0 : C5(8) = 0 : C5(9) = 0
3550 DIM C6(9)
3555 C6(1) = 0 : C6(2) = 0 : C6(3) = 0 : C6(4) = 0 : C6(5) = 0 : C6(6) = 0 : C6(7) = 0 : C6(8) = 0 : C6(9) = 0
3560 DIM C7(9)
3565 C7(1) = 0 : C7(2) = 0 : C7(3) = 0 : C7(4) = 0 : C7(5) = 0 : C7(6) = 0 : C7(7) = 0 : C7(8) = 0 : C7(9) = 0
3570 DIM C8(9)
3575 C8(1) = 0 : C8(2) = 0 : C8(3) = 0 : C8(4) = 0 : C8(5) = 0 : C8(6) = 0 : C8(7) = 0 : C8(8) = 0 : C8(9) = 0
3580 DIM C9(9)
3585 C9(1) = 0 : C9(2) = 0 : C9(3) = 0 : C9(4) = 0 : C9(5) = 0 : C9(6) = 0 : C9(7) = 0 : C9(8) = 0 : C9(9) = 0
3590 GOSUB 800 : REM FRE
3595 C1$ = "" : C2$ = "" : C3$ = "" : C4$ = "" : C5$ = "" : C6$ = "" : C7$ = "" : C8$ = "" : C9$ = ""
...
9800 HOME : PRINT "Entrance Room: empty."
...
11750 IF K = 197 OR K = 229 THEN GOTO 12300 : REM TOGGLE DEBUG WITH "E"
...
12500 IF A = 160 OR A = 90 OR A = 92 OR A = 93 OR A = 95 THEN X = X + 1 : GOSUB 100
...
13510 IF A = 160 OR A = 93 OR A = 95 OR A = 90 THEN Y = Y - 1 : GOSUB 100
...
14020 IF A = 160 OR A = 93 OR A = 95 OR A = 90 THEN Y = Y + 1 : GOSUB 100
...
15104 UX = 136 : VX = 22 : UY = 130 : VY = 0 : VTAB(22) : GOSUB 400 : REM PRINT CHOISES
15106 GOSUB 350
15110 REM UX = 197 : VX = 20 : UY =  50 : VY =  0 : GOSUB 400
15120 GOSUB 15600
15130 REM PRINT ENEMIES IN THE CURRENT ROOM
15140 FOR I = 1 TO 9
15150   IF C1(1) > 0 THEN HTAB(RX * 9 + 3) : VTAB(RY*4 + 2) : PRINT C1$ : REM C1(1) = 0
15160   IF C2(1) > 0 THEN HTAB(RX * 9 + 3) : VTAB(RY*4 + 3) : PRINT C2$ : REM C2(1) = 0
15170   IF C3(1) > 0 THEN HTAB(RX * 9 + 3) : VTAB(RY*4 + 4) : PRINT C3$ : REM C3(1) = 0
15180   IF C4(1) > 0 THEN HTAB(RX * 9 + 4) : VTAB(RY*4 + 2) : PRINT C4$ : REM C4(1) = 0
15190   IF C5(1) > 0 THEN HTAB(RX * 9 + 4) : VTAB(RY*4 + 3) : PRINT C5$ : REM C5(1) = 0
15200   IF C6(1) > 0 THEN HTAB(RX * 9 + 4) : VTAB(RY*4 + 4) : PRINT C6$ : REM C6(1) = 0
15210   IF C7(1) > 0 THEN HTAB(RX * 9 + 5) : VTAB(RY*4 + 2) : PRINT C7$ : REM C7(1) = 0
15220   IF C8(1) > 0 THEN HTAB(RX * 9 + 5) : VTAB(RY*4 + 3) : PRINT C8$ : REM C8(1) = 0
15230   IF C9(1) > 0 THEN HTAB(RX * 9 + 5) : VTAB(RY*4 + 4) : PRINT C9$ : REM C9(1) = 0
15240 NEXT I
15300 RETURN
...
15599 REM GENERATE ENEMIES 1:TYPE; 2:LEVEL; 3:ATTACK; 4:HEALTH; 5:DEFENSE; 6:AMMO; 7:DISTANCE; 8:ADVANCED; 9:SLOT
15600 C1(1) = 0 : C2(1) = 0 : C3(1) = 0 : C4(1) = 0 : C5(1) = 0 : C6(1) = 0 : C7(1) = 0 : C8(1) = 0 : C9(1) = 0
15605 IF RND(1)*3 > 1 THEN C1$ = "K" : C1(1) = 1 : C1(2) = 1 : C1(3) = A1(1) : C1(4) = H1(1) : C1(5) = D1(1) : C1(6) = M1(1) : C1(7) = 1 : C1(8) = 0 : C1(9) = 2
15610 IF RND(1)*3 > 1 THEN C2$ = "A" : C2(1) = 2 : C2(2) = 1 : C2(3) = A2(1) : C2(4) = H2(1) : C2(5) = D2(1) : C2(6) = M2(1) : C2(7) = 3 : C2(8) = 0 : C2(9) = 2
15620 IF RND(1)*4 > 2 THEN C3$ = "W" : C3(1) = 3 : C3(2) = 1 : C3(3) = A3(1) : C3(4) = H3(1) : C3(5) = D3(1) : C3(6) = M3(1) : C3(7) = 6 : C3(8) = 0 : C3(9) = 2
15630 IF RND(1)*6 > 3 THEN C4$ = "K" : C4(1) = 1 : C4(2) = 2 : C4(3) = A1(2) : C4(4) = H1(2) : C4(5) = D1(2) : C4(6) = M1(2) : C4(7) = 1 : C4(8) = 0 : C4(9) = 1
15640 IF RND(1)*8 > 5 AND Y < 17 THEN C5$ = "A" : C5(1) = 2 : C5(2) = 2 : C5(3) = A2(2) : C5(4) = H2(2) : C5(5) = D2(2) : C5(6) = M2(2) : C5(7) = 3 : C5(8) = 0 : C5(9) = 1
15650 IF RND(1)*9 > 6 AND Y < 17 THEN C6$ = "W" : C6(1) = 3 : C6(2) = 2 : C6(3) = A3(2) : C6(4) = H3(2) : C6(5) = D3(2) : C6(6) = M3(2) : C6(7) = 6 : C6(8) = 0 : C6(9) = 1
15660 IF RND(1)*9 > 7 AND Y < 9 THEN C7$ = "K" : C7(1) = 1 : C7(2) = 3 : C7(3) = A1(3) : C7(4) = H1(3) : C7(5) = D1(3) : C7(6) = M1(3) : C7(7) = 1 : C7(8) = 0 : C7(9) = 3
15660 IF RND(1)*9 > 7 AND Y < 9 THEN C8$ = "A" : C8(1) = 2 : C8(2) = 3 : C8(3) = A2(3) : C8(4) = H2(3) : C8(5) = D2(3) : C8(6) = M2(3) : C8(7) = 3 : C8(8) = 0 : C8(9) = 3
15670 IF RND(1)*9 > 8 AND Y < 9 THEN C9$ = "W" : C9(1) = 3 : C9(2) = 3 : C9(3) = A3(3) : C9(4) = H3(3) : C9(5) = D3(3) : C9(6) = M3(3) : C9(7) = 6 : C9(8) = 0 : C9(9) = 3
15700 RETURN
